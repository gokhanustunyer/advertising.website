    ...
    dialog.innerHTML += `
        <div class="mt-5 quicksand">
          ...
          <div class="form-group">
            ...
            <textarea class="user-input w-100 d-block" id="detailedAddress" rows="5"></textarea>
          </div>
          <hr>
...
var editAddress = (c, d, n, t, desc, id) => {
    ...
    dialog.innerHTML += `
        <div class="mt-5 quicksand">
          ...
          <div class="form-group">
            <small style="color:#b0b0b0">Açık Adres</small>
            <textarea class="user-input w-100 d-block" id="detailedAddress" rows="5">${desc}</textarea>
          </div>
          <hr>
