        ...
        htmlContent.innerHTML += `
                        <div class="mb-2" style="display:flex;justify-content:center;align-items:center">
                            ...
                            <div class="mt-4 d-flex">
                                ...
                                <a href="/admin/filterAdverts/${data[i]["id"]}" class="btn btn-sm btn-primary text-white" style="height:47px;display:flex;align-items:center;justify-content: center;">Ürünler</a>
